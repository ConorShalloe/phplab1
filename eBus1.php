...
<html lang="en" xmins="http.//www.w3.org/1999/xhtml">
    <head>
        ...
        <br />
            <center>
            <input type="button" name="btnCalc" id="btnCalc" onclick="calcSub()" value="Calculate Amount"style="background-color: black; font-size: 20px; color: white">
            <input type="button" name="btnClear" id="btnClear" onclick="AmountClear()" value="Clear"style="background-color: black; font-size: 20px; color: white">
            <input type="submit" name="btnProceed" id="btnProceed" onclick="" value="Add to Shopping Cart"style="background-color: black; font-size: 20px; color: white">
        </center>
            </form>
        </div>
        ...
        <center>
             <div>
        <form name="btnBack" method="post" action="ConsultingServicesHomepage.html">
            <input type="submit" name="btnBack" id="btnAbout" onclick="" value="Back to Consulting Services Homepage" style="background-color: black; font-size: 20px; color: white">
        </form>
    </div>
        </center>
    </body>
